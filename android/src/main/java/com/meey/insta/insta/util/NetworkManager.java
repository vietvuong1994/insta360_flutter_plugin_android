...
public class NetworkManager {
    ...
    public void exchangeNetToMobile() {
        ...
        ConnectivityManager connManager = (ConnectivityManager) InstaPlugin.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
        ...
        mNetworkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(Network network) {
                ...
                if (bindSuccessful) {
                    Toast.makeText(InstaPlugin.getInstance(), R.string.live_toast_bind_mobile_network_successful, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(InstaPlugin.getInstance(), R.string.live_toast_bind_mobile_network_failed, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onLost(Network network) {
                ...
                Toast.makeText(InstaPlugin.getInstance(), R.string.live_toast_unbind_mobile_network_when_lost, Toast.LENGTH_SHORT).show();
            }
        };
    ...
    public void clearBindProcess() {
        ...
        if (mNetworkCallback != null) {
            ...
            Toast.makeText(InstaPlugin.getInstance(), R.string.live_toast_unbind_mobile_network, Toast.LENGTH_SHORT).show();
        }
